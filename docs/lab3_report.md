...
Текущая реализация (Work in Progress) уже включает ключевые механизмы расширенного «Сапера», такие как система весов для расчета окружающих мин и поддержка анти-мин.

Однако анализ кода выявил нарушение принципа разделения ответственности: присутствуют прямые зависимости между слоем представления и слоем данных, а также игровым движком и утилитами сжатия.

![Текущая архитектура](./As_IS.png)
*Рисунок 2. Архитектурная схема текущего состояния (As Is)*

### 2.1. Фактическая диаграмма классов
На основе текущего исходного кода была построена детальная диаграмма классов. Она отражает реальную структуру проекта, включая логику игрового движка, моделей и управление интерфейсом.
